...
Create the issue [here](https://gitlab.com/exadra37/my-base-repository/issues/new) with the template
...
Create each issue [here](https://gitlab.com/exadra37/my-base-repository/issues/new) using the relevant template:
